...
990 data pull.ipynb : This is the running code for the Phil dataset. The code pulls 990 information via EINs and outputs a dataset. It includes the manipulation to fix errors, extract missing information from the 990 Manual Pull, and expand every fiscal year by month.
